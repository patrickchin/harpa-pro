 ...
 * `placement = { kind: 'section', index: i }` must render inside that
 * section card (via `PlacedPhotoStrip`), and must NOT render in the
 * bottom "Unplaced photos" grid.
 */
...
const REPORT = {
  report: {
    ...
    sections: [
      ...
      { title: 'Roof', content: 'Roof needs work.' },
    ],
    workers: null,
    materials: [],
    nextSteps: [],
...
const PHOTO_PLACED_IN_SECTION = {
  ...
  title: 'Placed photo',
  cacheKey: 'fil_placed',
  placement: { kind: 'section' as const, index: 1 },
};
