...
| `EMAIL`                 | `alice@dev.harpa.test`               | Primary test account (in dev's `TEST_ACCOUNT_EMAILS`).             |
| `EMAIL2`                | `bob@dev.harpa.test`                 | Secondary test account for cross-user / member tests.              |
