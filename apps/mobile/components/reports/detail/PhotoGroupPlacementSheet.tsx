 ...
 *    current placement, and writes `placement: null`.
 *
 ...
 * wires to `useOptimisticPlacePhotoGroup`. Closing without a tap is a
...
export function PhotoGroupPlacementSheet({
  ...
  return (
    ...
    >
      <View testID={testID ?? 'sheet-photo-placement'}>
        {noTargets ? (
