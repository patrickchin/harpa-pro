/**
 * Short-URL resolver landing — /r/:report.
 *
 * Resolves the report slug to {projectId, reportNumber} then
 * `router.replace`s to the canonical long URL
 * `/projects/:project/reports/:number`. See
...
export default function ResolveReportSlugScreen() {
  ...
  const result = useResolveReportSlugQuery({ params: { report } });
