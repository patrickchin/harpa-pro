...
MSYS_NO_PATHCONV=1 docker run --rm --network container:harpa-pro-minio --volumes-from harpa-pro-minio --entrypoint /bin/sh quay.io/minio/mc:RELEASE.2025-08-13T08-35-41Z -c '
set -eu
