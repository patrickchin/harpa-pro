...
- **2026-07-31** — Local, CI, OTA, and Fly processes selected Node 20, 22, or Homebrew's 26, while the admin provisioning CLI timed out under Node 22/24 on dual-stack DNS without usable IPv6. Fix: pin Node 24.18.1 everywhere, enforce the pin in CI, and scope single-family selection to the one-off CLI. [detail](2026-07-31-node-runtime-admin-cli-timeout.md)
