# Design v1 — Manual photo-group placement into report sections (SHIPPED, SUPERSEDED)

> Status: shipped in PR #129 against `dev`. **Superseded by
> [design-photo-placement.md](design-photo-placement.md) (v2)**, which
