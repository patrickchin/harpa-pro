...
- **2026-08-04** — The PR-time Android smoke opened its Metro deep link immediately after a clear-state launch without first asserting Expo Dev Launcher readiness; run 30924240940 then skipped the server row and never mounted app UI. Fix: require the native `Development Build` screen within 30 seconds before opening the bounded deep link. [detail](2026-08-04-expo-dev-launcher-readiness-race.md)
