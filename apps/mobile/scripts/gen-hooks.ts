...
const ENDPOINTS: Endpoint[] = [
  ...
  // auth — better-auth handles /api/auth/** outside the OpenAPI contract.
  // No hooks needed; the mobile uses authClient from lib/auth/client.ts directly.
  ...
  { method: 'get',    path: '/projects/{project}',                hook: 'useProjectQuery',              query: true,  hasPathParams: true,  hasBody: false, queryKeyHead: 'project' },
  { method: 'patch',  path: '/projects/{project}',                hook: 'useUpdateProjectMutation',     query: false, hasPathParams: true,  hasBody: true },
  { method: 'delete', path: '/projects/{project}',                hook: 'useDeleteProjectMutation',     query: false, hasPathParams: true,  hasBody: false },
  ...
  { method: 'post',   path: '/projects/{project}/reports',                          hook: 'useCreateReportMutation',      query: false, hasPathParams: true,  hasBody: true },
  ...
  { method: 'get',    path: '/r/{report}',                        hook: 'useResolveReportSlugQuery',    query: true,  hasPathParams: true,  hasBody: false, queryKeyHead: 'resolveReportSlug' },
