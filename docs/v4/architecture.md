...
| 15a | **Photo placement** | [design-photo-placement.md](design-photo-placement.md) | **Lets the user attach a photo group to a specific issue or summary section: nullable `notes.placement` jsonb, `PATCH /notes/{n}/placement`, `MapPin` chip + `AppDialogSheet` picker, self-healing orphans** |
