...
| 11d | **CLI TUI v4 (split-pane render)** | [arch-tui-layout.md](arch-tui-layout.md) | **OpenTUI + Solid on Bun: static two-pane layout (viewport + interaction), `Prompter` interface preserved, replaces clack rendering from 11a–c** |
