 ...
 * in node.
 *
 * Layout: header (author + timestamp) → status row (mic + label +
 * duration + play/retry) → optional summary + transcript expander.
 *
 ...
 * inline pill is the entire failure UX (retry handled by caller).
 */
