...
- cards and navigation items: 12 px radius;
- exceptional floating surface: 16 px radius;
- default border: 1 px;
...
- Controls keep a 44 px minimum target and 10 px radius.
...
- Cards use a 12 px radius, one-pixel border, and restrained shadow.
- Object rows use a 40 px icon/avatar, 4 px text stack, and 12–16 px padding.
- Tabs sit in a bordered 12 px container.
